...
const GoodHands = () => {
  return (
    <section className='grid gap-y-[35px] lg:gap-y-[0px] grid-cols-[10%_auto_10%] lg:grid-cols-[18%_16%_16%_16%_16%_18%] grid-rows-[auto_auto_auto_1fr_1fr] lg:grid-rows-[auto_auto_auto_auto_auto]'>
      <div className='grid-item-1 col-start-2 col-end-6 row-start-5 row-end-6 lg:col-start-1 lg:col-end-4 lg:row-start-1 lg:row-end-6'>
        <div className='w-full h-full lg:h-[100%] relative'>
          ...
          <div className="absolute w-full h-[335px] lg:h-full z-9 top-0 left-0 mask-wrapper after:content-[' '] after:inline-block after:w-full after:h-full after:absolute after:bg-mask2mobile lg:after:bg-mask2 after:bg-position-mask1 after:bg-no-repeat after:bg-cover mt-[-20px] lg:mt-0"></div>
        </div>
      </div>
      ...
      <div className='grid-item-3 col-start-1 col-end-3 row-start-2 row-end-3 lg:col-start-3 lg:col-end-5 lg:row-start-2 lg:row-end-4 relative pb-0'>
        ...
        <div className='absolute left-[150px] !top-[205px] lg:!top-[150px] lg:left-[250px]'>
          ...
          <p className='text-[12px] lg:text-[14px] text-primary-black mb-[0px] max-w-[220px]'>
            Votre assurance personnalisable à portée de clic. C'est le contrat
            qui s'adapte à vous et non l'inverse.
          </p>
        </div>
      </div>
      <div className='grid-item-4 col-start-2 col-end-3 row-start-3 row-end-4 lg:col-start-5 lg:col-end-7 lg:row-start-3 lg:row-end-5 relative mt-[50px] lg:mt-0'>
        <div className='z-1 relative'>
        ...
        <div className='absolute top-[220px] left-[75px] lg:!top-[250px] lg:left-[100px]'>
          ...
          <p className='text-[12px] lg:text-[14px] text-primary-black mb-[0px] max-w-[248px]'>
      ...
      <div className='grid-item-5 col-start-2 col-end-4 row-start-4 row-end-5 lg:col-start-2 lg:col-end-5 lg:row-start-4 lg:row-end-6 relative flex justify-end lg:justify-start'>
        ...
        <div className='absolute !top-[215px] left-[25px] lg:!top-[95px] lg:left-[250px]'>
          ...
          <p className='text-[12px] lg:text-[14px] text-primary-black mb-[0px] max-w-[250px]'>
