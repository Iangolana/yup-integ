! function(e) {
  ...
  t.defaultScrollOptions = {
      ...
      goToTopOnLast: !0,
      mediaQuery: "screen",
      slideSelector: ".section-item"
  };
  var u = function(e) {
      function n(n, r) {
          var o = e.call(this) || this;
          if (o.addStylesAndEvents = function() {
                  window.scroll(0, 0), o.currentSlide = 0, document.body.style.overflow = "hidden", o.wrapperElement.style.transform = "translateY(0)", o.wrapperElement.style.transition = o.options.transitionTime.toString() + "ms cubic-bezier(0.5, 0, 0.5, 1)", o.swipeEventHandler.addEventListeners(), o.scrollEventHandler.addEventListeners(), o.isActive = !0, o.dispatchEvent(new Event("activate"))
              }, o.removeStylesAndEvents = function() {
                  document.body.style.overflow = "auto", o.wrapperElement.style.transform = "none", o.wrapperElement.style.transition = "none", o.swipeEventHandler.removeEventListeners(), o.scrollEventHandler.removeEventListeners(), o.isActive = !1, o.dispatchEvent(new Event("deactivate"))
                  ...
                  if (!(e === o.currentSlide || e < 0)) {
                      ...
                      if (!1 === o.waitForAnimation) {
                          ...
                          var n = 100 * -e;
                          o.currentSlide = e, o.wrapperElement.style.transform = "translateY(" + n + "vh)", o.dispatchEvent(t), setTimeout(function() {
  ...
  Object.defineProperty(t, "__esModule", {
      ...
      function(e) {
          e.NONE = "NONE", e.UP = "UP", e.DOWN = "DOWN", e.LEFT = "LEFT", e.RIGHT = "RIGHT"
      }(r || (r = {}));
  var i = function() {
      return function(e, t, n, i) {
          var a = this;
          this.addEventListeners = function() {
              a.target.addEventListener("touchstart", a.touchstartEventHandler), a.target.addEventListener("touchend", a.touchendEventHandler), a.target.addEventListener("touchmove", a.touchmoveEventHandler)
          }, this.removeEventListeners = function() {
              a.target.removeEventListener("touchstart", a.touchstartEventHandler), a.target.removeEventListener("touchend", a.touchendEventHandler), a.target.removeEventListener("touchmove", a.touchmoveEventHandler)
          }, this.touchstartEventHandler = function(e) {
              var t = e.changedTouches[0];
              a.touchEvent.swipeDirection = r.NONE, a.touchEvent.touchstartPageX = t.pageX, a.touchEvent.touchstartPageY = t.pageY, a.touchEvent.touchstartTime = (new Date).getTime()
          }, this.touchendEventHandler = function(e) {
              var t = r.NONE,
                  n = e.changedTouches[0],
                  o = n.pageX - a.touchEvent.touchstartPageX,
                  i = n.pageY - a.touchEvent.touchstartPageY;
              (new Date).getTime() - a.touchEvent.touchstartTime <= a.swipeOptions.maxSwipeTime && (Math.abs(o) > Math.abs(i) ? Math.abs(o) > a.swipeOptions.swipeMinDistance && (t = o < 0 ? r.LEFT : r.RIGHT) : Math.abs(i) > a.swipeOptions.swipeMinDistance && (t = i < 0 ? r.UP : r.DOWN), t === r.UP ? a.nextCallback() : t === r.DOWN && a.previousCallback(), e.stopPropagation())
          }, this.touchmoveEventHandler = function(e) {
              e.preventDefault()
          }, this.target = e, this.nextCallback = t, this.previousCallback = n, this.swipeOptions = {
              swipeMinDistance: 30,
              maxSwipeTime: 500
          }, i && (this.swipeOptions = o({}, this.swipeOptions, i)), this.touchEvent = {
              swipeDirection: r.NONE
          }
      }
  }();
      ...
      return function(e, n, o, i) {
          ...
          this.addEventListeners = function() {
              ...
              var r = (new Date).getTime(),
                  o = r - a.lastCall;
              a.lastCall = r, !n && o < a.options.newScrollThreshold || (e.stopPropagation(), t < 0 && a.previousCallback(), t > 0 && a.nextCallback())
          }, this.target = e, this.nextCallback = n, this.previousCallback = o, this.options = r({}, t.defaultWheelOptions, i)
      }
  }();
  ...
  var r = function() {
      return function(e, t, n) {
          var r = this;
          this.addEventListeners = function() {
              "addEventListener" in r.target ? r.target.addEventListener("change", r.changeEventHandler) : window.addEventListener("resize", r.resizeEventHandler)
          }, this.removeEventListeners = function() {
              "removeEventListener" in r.target ? r.target.removeEventListener("change", r.changeEventHandler) : window.removeEventListener("resize", r.resizeEventHandler)
          }, this.resizeEventHandler = function(e) {
              r.tagetMatches !== r.target.matches && (r.tagetMatches = r.target.matches, r.target.matches ? r.matchesCallback() : r.noMatchesCallback())
          }, this.changeEventHandler = function(e) {
              e.stopPropagation(), r.tagetMatches = r.target.matches, r.target.matches ? r.matchesCallback() : r.noMatchesCallback()
          }, this.target = e, this.tagetMatches = this.target.matches, this.matchesCallback = t, this.noMatchesCallback = n
      }
  }();
  ...
  function u(e) {
      ...
      return null == t && (t = function(e, t) {
          ...
          return r
      }(u(Object.getPrototypeOf(e)), e), o.set(e, t)), t
  }
  ...
  s.prototype = {get type() {
      ...
      configurable: !0,
      writable: !0
  }), "undefined" != typeof window && void 0 !== window.Event && (Object.setPrototypeOf(s.prototype, window.Event.prototype), o.set(window.Event.prototype, s));
  const v = new WeakMap,
      f = 3;
      ...
      Object.defineProperty(e, `on${t}`, function(e) {
          return {
              get() {
                  ...
                  let r = null,
                      o = n.get(e);
                  for (; null != o;) o.listenerType === f ? null !== r ? r.next = o.next : null !== o.next ? n.set(e, o.next) : n.delete(e) : r = o, o = o.next;
                  if (null !== t) {
                      const o = {
                          listener: t,
                          listenerType: f,
  ...
  b.prototype = {
      addEventListener(e, t, n) {
          ...
          let a = null;
          for (; null != r;) {
              if (r.once ? null !== a ? a.next = r.next : null !== r.next ? t.set(n, r.next) : t.delete(n) : a = r, d(o, r.passive ? r.listener : null), "function" == typeof r.listener) try {
                  r.listener.call(this, o)
              } catch (e) {
                  "undefined" != typeof console && "function" == typeof console.error && console.error(e)
              } else r.listenerType !== f && "function" == typeof r.listener.handleEvent && r.listener.handleEvent(o);
              if (p(o)) break;
              r = r.next
          }
          return d(o, null),
      ...
      configurable: !0,
      writable: !0
  }), "undefined" != typeof window && void 0 !== window.EventTarget && Object.setPrototypeOf(b.prototype, window.EventTarget.prototype), t.defineEventAttribute = E, t.EventTarget = b, t.default = b, e.exports = b, e.exports.EventTarget = e.exports.default = b, e.exports.defineEventAttribute = E
}]);